...
<div class="bg-main">
	...
	$query = $connection->query("SELECT * from services");
...
?>
				<div class="grid_8">
					...
					<img src="images/2page_img1.jpg" alt="">
					<p class="pad"><?php echo $row->unique_name; ?></p>
					<!--<a href="payme.php&service_id=<?php echo $tuka; ?>" class="button">Buy tickets for 4500 tenge</a>-->
				<form action="payme.php" method="get">
<input type="hidden" name="service_id" value = "<?php echo $tuka; ?>">
<input type="submit">
</form>
